...
describe('E-COMMERCE WEBSITE - SELENIUM TEST SUITE', function() {
  ...
  describe('HOMEPAGE FUNCTIONALITY TESTS', function() {
    ...
    it('TC001: Homepage Load & Title Verification', async function() {
      ...
      printSection('TEST CASE 001: HOMEPAGE LOAD & TITLE VERIFICATION');
      ...
      try {
        ...
        await webDriverConfig.takeScreenshot('clean-tc001-homepage-load');
        ...
        testResults.push({
          ...
          status: 'passed',
          duration,
          screenshot: 'clean-tc001-homepage-load.png'
        });
        ...
        await webDriverConfig.takeScreenshot('clean-tc001-failed');
        throw error;
      }
    });
    ...
    it('TC002: React Application Integrity Check', async function() {
      ...
      try {
        ...
        await webDriverConfig.takeScreenshot('clean-tc002-react-integrity');
        ...
        testResults.push({
          ...
          status: 'passed',
          duration,
          screenshot: 'clean-tc002-react-integrity.png'
        });
        ...
        printTestStep(`Test failed: ${error.message}`, 'error');
        await webDriverConfig.takeScreenshot('clean-tc002-failed');
        throw error;
      }
    });
    ...
    it('TC003: User Interaction & Navigation Testing', async function() {
      ...
      printSection('TEST CASE 003: USER INTERACTION & NAVIGATION TESTING');
      ...
      try {
        ...
        printMetric('Scroll Behavior', `Tested (0->500px->0)`);
        ...
        await webDriverConfig.takeScreenshot('clean-tc003-interactions');
        ...
        testResults.push({
          ...
          status: 'passed',
          duration,
          screenshot: 'clean-tc003-interactions.png'
        });
        ...
        printTestStep(`Test failed: ${error.message}`, 'error');
        await webDriverConfig.takeScreenshot('clean-tc003-failed');
        throw error;
      }
    });
    ...
    it('TC004: Responsive Design Cross-Device Testing', async function() {
      ...
      try {
        ...
        for (const device of devices) {
          ...
          await webDriverConfig.takeScreenshot(`clean-tc004-${device.name.toLowerCase().replace(' ', '-')}`);
        ...
        testResults.push({
          ...
          status: 'passed',
          duration,
          screenshot: 'clean-tc004-[device].png (3 files)'
        });
        ...
        printTestStep(`Test failed: ${error.message}`, 'error');
        await webDriverConfig.takeScreenshot('clean-tc004-failed');
        throw error;
      }
    });
    ...
    it('TC005: Error Recovery & Stability Testing', async function() {
      ...
      printSection('TEST CASE 005: ERROR RECOVERY & STABILITY TESTING');
      ...
      try {
        ...
        await webDriverConfig.takeScreenshot('clean-tc005-stability');
        ...
        testResults.push({
          ...
          status: 'passed',
          duration,
          screenshot: 'clean-tc005-stability.png'
        });
        ...
        printTestStep(`Test failed: ${error.message}`, 'error');
        await webDriverConfig.takeScreenshot('clean-tc005-failed');
        throw error;
      }
    });
  });
